...
const Hero = () => {
	...
	const scale = useTransform(scrollYProgress, [0, 1.2], [1, 0.6]);
		...
		>
			...
			>
				<div className="flex items-center justify-between w-full">
					<p className={`text-3xl font-bold uppercase ${accent.className}`}>
						Fede.
					</p>
					<div className="flex items-center gap-4">
						...
						<div>
							<Button asChild>
								<a
									href="mailto:federicoluna.dev@gmail.com"
									target="_blank"
				...
				<div className="flex flex-col gap-10">
					<div className="flex gap-4 lg:gap-14 flex-col lg:flex-row">
						...
						>
							...
							<h1 className="sr-only">Fullstack Developer</h1>
							<h2 className="sr-only">Diseñador web.</h2>
						</div>
						<div className="w-auto lg:w-1/3 self-auto lg:self-end">
							...
							>
								Me gusta crear aplicaciones y sitios webs copados e intento que
								queden lindos.
							</TextAnimate>
						</div>
