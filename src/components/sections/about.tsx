		...
		>
			<div className="container flex flex-col xl:flex-row items-center justify-between gap-20 xl:gap-4 mx-auto">
				<div className="max-w-3xl text-center xl:text-left ">
					<h1
						className={`${accent.className} text-2xl md:text-4xl font-bold uppercase`}
					>
						<TextAnimate animation="slideUp" by="word" duration={200}>
							Soy Federico Luna, desarrollador web fullstack.
						</TextAnimate>
					</h1>
					<p className="text-xl md:text-3xl mt-4 text-[#e2e2e2]">
						Tengo 22 años y soy de Zavalla, Argentina, actualmente estudio
					...
					<div className="mt-4 flex gap-2 flex-col items-center xl:items-start">
						...
						<Button className="w-fit" asChild>
							<a
								href="https://drive.google.com/file/d/1PdEJIvMPhuuJ__clqXdaicP-bmnQkf5s/view?usp=sharing"
								target="_blank"
								rel="noopener"
							>
								Ver CV
				...
				<div className="relative">
					...
					>
						...
						<p className="text-base md:text-xl text-white/80 leading-tight">
