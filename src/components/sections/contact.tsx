				...
				<div className="sticky top-[calc(100vh-600px)] h-[600px]">
					<div className="flex text-black items-center justify-center h-full flex-col">
						<div className="flex flex-col items-center justify-center gap-4 h-full text-center ">
							...
							<p
								className={`${accent.className} uppercase text-3xl sm:text-4xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-9xl font-bold`}
							>
								Trabajemos juntos
							</p>
							<Button
						...
						<footer className="mt-auto p-4">
							<p className="text-base text-center md:text-xl ">
								© {year} Fede. Todos los derechos reservados.
							</p>
						</footer>
					</div>
				</div>
