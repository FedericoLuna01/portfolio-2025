...
export const data = {
	socials: [
		...
		{
			name: "Gmail",
			url: "mailto:federicoluna.dev@gmail.com",
			icon: GmailIcon,
		},
	],
	projects: [
		...
		},
		{
			...
			description:
				"Extensión de Chrome para personalizar la interfaz de YouTube",
			images: [
	...
	landingProjects: [
		{
			...
			images: ["/projects/landing-comuna.webp"],
		...
		},
		{
			...
			title: "Kuzacademy",
			description:
				"Plataforma de cursos en línea de criptomonedas y blockchain",
			images: ["/projects/landing-criptokuz.webp"],
		...
		},
		{
			...
			images: ["/projects/landing-maxitramit.webp"],
